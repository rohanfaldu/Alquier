    ...
    return (
        <>
            <div>
                ...
                {(isShowDiscountDetail) && ( <div className="bg-[#0E1330] opacity-50 fixed w-[100%] h-[100%] z-2 top-0"></div>)}
                ...
                {(isShowDiscountDetail) && (
                    <div className={` bg-white ${(isShowDiscountDetail) ? 'show z-2 fixed w-[100%] bottom-0 rounded-t-[24px]' : 'hide'}`}>
