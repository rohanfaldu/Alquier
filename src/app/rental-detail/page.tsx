                ...
                <div className="p-4 bg-[#FFFFFF] rounded-b-[20px] shadow-sm">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center flex-1">
                            ...
                            <div className="flex-1 flex relative -top-[10px] h-[3px] right-[10px] rounded-full bg-[#D9D9D9]"></div>

                            {/* Step 3 */}
                            <div className="flex flex-col relative items-center right-[5px]">
                                <div className="w-8 h-8 rounded-full border-2 border-[#D9D9D9] flex items-center justify-center font-open-sans font-medium text-[12px] leading-[16px] text-[#474953]">
                                    3
                                </div>
